<template>
  <el-menu :default-openeds="['2', 'book']" style="height: 100%;"
...
export default {
  ...
  computed: {
    ...
    BookGroup: function (){
      return this.menuFlags.bookMenu ||this.menuFlags.orderMenu || this.menuFlags.categoryMenu || this.menuFlags.carouselMenu
    },
