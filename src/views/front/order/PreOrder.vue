...
export default {
  ...
  created() {
    ...
    this.book.realPrice = this.$route.query.realPrice;
    this.book.num = this.$route.query.num;
    this.book.standard = this.$route.query.standard;
  ...
  computed: {
    ...
    sumDiscount: function () {
      let sum = 0;
      this.books.forEach(function (book) {
        sum += (book.realPrice / book.discount - book.realPrice) * book.num;
      });
      return sum.toFixed(2);
    },
  },
