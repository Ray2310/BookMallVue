...
const routes = [
    //前台
  {
    ...
    children: [
      ...
      {path: 'cart', name: 'cart', meta: {title:'我的购物车',requireLogin: true}, component: () => import('../views/front/book/Cart.vue'),},
      {path: 'bookList', name: 'bookList', meta: {title:'商品界面'}, component: () => import('../views/front/book/BookList.vue'),},
      {path: 'bookView/:bookId', name: 'bookview', meta: {title:'商品详情'}, component: () => import('../views/front/book/BookView.vue'),},
    ...
    //后台
  {
    ...
    children: [
      ...
      {path: 'carousel', name: 'carousel', meta: {title:'轮播图管理',path: '商品/轮播图管理',requireAuth: true}, component: () => import('../views/manage/book/Carousel.vue'),},
      {path: 'category', name: 'category', meta: {title:'商品分类管理',path: '商品/商品分类管理',requireAuth: true}, component: () => import('../views/manage/book/Category.vue'),},
      {path: 'book', name: 'book', meta: {title:'商品管理',path: '商品/商品管理',requireAuth: true}, component: () => import('../views/manage/book/Books.vue'),},
      {path: 'bookInfo', name: 'bookInfo', meta: {title:'商品管理',path: '商品/商品管理/商品信息',requireAuth: true}, component: () => import('../views/manage/book/BookInfo.vue'),},
