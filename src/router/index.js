...
const routes = [
    //前台
  {
    ...
    meta: {title:'在线书城', path: '在线书城', requireAuth: false},
    children: [
      {path: 'person', name: 'person', meta: {title:'个人信息',requireLogin: true}, component: () => import('../views/Person.vue'),},
      {path: 'topview', name: 'topview', meta: {title:'在线书城'}, component: () => import('../views/front/TopView.vue'),},
      {path: 'cart', name: 'cart', meta: {title:'我的购物车',requireLogin: true}, component: () => import('../views/front/book/Cart.vue'),},
      {path: 'bookList', name: 'bookList', meta: {title:'书籍界面'}, component: () => import('../views/front/book/BookList.vue'),},
      {path: 'bookView/:bookId', name: 'bookview', meta: {title:'书籍详情'}, component: () => import('../views/front/book/BookView.vue'),},
    ...
    //后台
  {
    ...
    children: [
      ...
      {path: 'carousel', name: 'carousel', meta: {title:'轮播图管理',path: '书籍/轮播图管理',requireAuth: true}, component: () => import('../views/manage/book/Carousel.vue'),},
      {path: 'category', name: 'category', meta: {title:'书籍分类管理',path: '书籍/书籍分类管理',requireAuth: true}, component: () => import('../views/manage/book/Category.vue'),},
